...
@section('title', "Faq category create")
@section('content')
    ...
    <div class="col-span-12 lg:col-span-8 2xl:col-span-9">
      ...
      <div class="intro-y box lg:mt-5">
        <div class="flex items-center p-5 border-b border-slate-200/60 dark:border-darkmode-400">
          <h2 class="font-medium text-base mr-auto"> Create a category </h2>
        </div>
        <div class="p-5">
          <div class="flex flex-col-reverse xl:flex-row flex-col">
            <form method="POST" action="{{route('settings.help.create_category')}}">
              @csrf
                ...
                <div class="grid grid-cols-12 gap-x-5">
                  <div class="col-span-12 2xl:col-span-6">
                    <div>
                      ...
                      <input name="categoryTitle" type="text" class="form-control" placeholder="Category title" >
                    </div>
                  </div>
                  <div class="col-span-12 2xl:col-span-6">
                    <div class="mt-2">
                      <label class="form-label">Width</label>
                      <input name="categoryWidth" type="number" min="1" max="12" class="form-control" value="12" placeholder="Category width" >
                    </div>
                  </div>
                  <div class="col-span-12 2xl:col-span-6">
                    <div class="mt-2">
                      <label class="form-label">Width for large scale screens</label>
                      <input name="categoryWidthLg" type="number" min="1" max="12" class="form-control" value="6" placeholder="Category width" >
                    </div>
                  </div>
                </div>
