      ...
      <div class="intro-y box lg:mt-5">
        ...
        <div class="p-5">
          <div class="flex flex-col-reverse xl:flex-row flex-col">
            <form method="POST" action="{{route('settings.help.create_faq')}}">
              @csrf
                ...
                <div class="grid grid-cols-12 gap-x-5">
                  <div class="col-span-12 2xl:col-span-6">
                    <div>
                      ...
                      <input name="faqTitle" type="text" class="form-control" placeholder="Faq title" >
                    </div>
                  </div>
                  ...
                  <div class="col-span-12 2xl:col-span-6">
                    <div>
                      ...
                      <select name="faqCategory" type="text" class="form-control"  >
                        ...
                        <option value="{{$categorey->id}}">{{$categorey->title}}</option>
                        @endforeach
                      </select>
                    </div>
                  </div>
                  ...
                  <div class="col-span-12 2xl:col-span-6 mt-2">
                    <div>
                      ...
                      <textarea name="faqContent" class="form-control" placeholder="Faq content" ></textarea>
                    </div>
                  </div>
