...
@endphp
@section('content')
<form action="{{route('investors.style.update')}}" method="POST" enctype="multipart/form-data">
  @csrf
  @method('patch')
      ...
      <div class="col-span-12 lg:col-span-4 2xl:col-span-3 flex lg:block flex-col-reverse">
        <div class="intro-y box mt-5">
          ...
          <div class="p-5 border-t border-slate-200/60 dark:border-darkmode-400">
            ...
            <a class="flex items-center mt-5 text-primary font-medium" href="{{route('investors.style.edit')}}">
                ...
                <div class="grid grid-cols-12 gap-x-5">
                  ...
                  <div class="col-span-12 2xl:col-span-6">
                    <div class="mt-3">
                      ...
                      <div class="form-check form-switch ml-auto">
                          <input name="dark_mode" class="form-check-input form-control" type="checkbox" {{Auth::guard('investor')->user()->dark?'checked':''}}>
                      </div>
                    </div>
                  </div>
                  <div class="col-span-12 2xl:col-span-6">
                    <div class="mt-3">
                      ...
                      <input id="primary_color" name="primary_color" type="color"  value="{{ rgbToHex(Auth::guard('investor')->user()->primary_color) }}">
                    </div>
                  </div>
                  <div class="col-span-12 2xl:col-span-6">
                    <div class="mt-3">
                      <label for="secondary_color" class="form-label">Secondary color</label><br>
                      <input id="secondary_color" name="secondary_color" type="color"  value="{{ rgbToHex(Auth::guard('investor')->user()->secondary_color) }}">
                    </div>
                  </div>
                  <div class="col-span-12 2xl:col-span-6">
                    <div class="mt-3">
                      <label for="warning_color" class="form-label">Warning color</label><br>
                      <input id="warning_color" name="warning_color" type="color"  value="{{ rgbToHex(Auth::guard('investor')->user()->warning_color) }}">
                    </div>
                  </div>
                  <div class="col-span-12 2xl:col-span-6">
                    <div class="mt-3">
                      <label for="danger_color" class="form-label">Danger color</label><br>
                      <input id="danger_color" name="danger_color" type="color"  value="{{ rgbToHex(Auth::guard('investor')->user()->danger_color) }}">
                    </div>
                  </div>
                  <div class="col-span-12 2xl:col-span-6">
                    <div class="mt-3">
                  ...
                  <div class="col-span-12 2xl:col-span-6">
                    <div class="mt-3">
                      ...
                      <input id="success_color" name="success_color" type="color"  value="{{ rgbToHex(Auth::guard('investor')->user()->success_color) }}">
                    </div>
                  </div>
