        ...
        <div class="notification-content__box dropdown-content">
          ...
          <div class="cursor-pointer relative flex items-center ">
            ...
            <div class="ml-2 overflow-hidden">
              ...
              <div class="w-full truncate text-slate-500 mt-0.5">It is a long established fact that a reader will be {{asset('assets/dashboardracted by the readable')}} content of a page when looking at its layout. The point of using Lorem </div>
            </div>
          </div>
      ...
      <div class="dropdown-menu w-56">
        <ul class="dropdown-content bg-primary/80 before:block before:absolute before:bg-black before:inset-0 before:rounded-md before:z-[-1] text-white">
          <li class="p-2">
            ...
            <div class="text-xs text-white/60 mt-0.5 dark:text-slate-500">{{Auth::guard('investor')->user()->role}}</div>
          </li>
          <li>
            <hr class="dropdown-divider border-white/[0.08]">
          </li>
          <li>
            <a href="{{route('investors.profile.edit')}}" class="dropdown-item hover:bg-white/5">
              <i data-lucide="user" class="w-4 h-4 mr-2"></i> Profile </a>
          </li>
          <li>
            <a href="{{route('investors.password.edit')}}" class="dropdown-item hover:bg-white/5">
              <i data-lucide="lock" class="w-4 h-4 mr-2"></i> Change Password </a>
          </li>
          <li>
            <a href="{{route('help.investors')}}" class="dropdown-item hover:bg-white/5">
