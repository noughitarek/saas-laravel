    ...
    <ul class="scrollable__content py-2">
      <li>
        <a href="javascript:;.html" class="menu menu--active">
          ...
          <div class="menu__title"> Dashboard <i data-lucide="chevron-down" class="menu__sub-icon transform rotate-180"></i>
          </div>
        </a>
        ...
        <ul class="">
          ...
          <li>
            <a href="javascript:;" class="menu">
              ...
              <div class="menu__title"> Transactions <i data-lucide="chevron-down" class="menu__sub-icon "></i>
              </div>
            </a>
            <ul class="">
              <li>
        ...
        <ul class="">
          ...
          <li>
            <a href="javascript:;" class="menu">
              ...
              <div class="menu__title"> Wysiwyg Editor <i data-lucide="chevron-down" class="menu__sub-icon "></i>
              </div>
            </a>
            <ul class="">
              <li>
